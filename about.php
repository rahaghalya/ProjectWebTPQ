        ...
        <div class="col-lg-6" data-aos="fade-right" data-aos-delay="200">
          <div class="content">
            ...
            <div class="cta-section" data-aos="fade-up" data-aos-delay="300">
              <a href="Guru.php" class="btn-link">Kenali Pengajar Kami <i class="bi bi-arrow-right"></i></a>
            </div>
          </div>
        </div>
      ...
      <div class="row justify-content-center">
        <div class="col-lg-10">
          <div class="struktur-img text-center">
            <img src="assets/img/about/Diagram Tanpa Judul.drawio.png" class="img-fluid" alt="Struktur Organisasi TPQ Roudlotul Ilmi">
          </div>
        </div>
      </div>
    </div>
