  ...
  <div class="card mb-4">
    <div class="card-body">
      ...
      <table class="table table-bordered">
        <tr><th>No Induk</th><td><?php echo $resV['no_induk']; ?></td></tr>
        <tr><th>Nama</th><td><?php echo htmlspecialchars($resV['nama']); ?></td></tr>
        <tr><th>Tempat &amp; Tgl Lahir</th><td><?php echo htmlspecialchars($resV['Tempat_tanggal_lahir']); ?></td></tr>
        <tr><th>Alamat</th><td><?php echo htmlspecialchars($resV['Alamat']); ?></td></tr>
        <tr><th>Jilid</th><td><?php echo htmlspecialchars($resV['jilid']); ?></td></tr>
        <tr><th>Tahun Masuk</th><td><?php echo htmlspecialchars($resV['Tahun_masuk']); ?></td></tr>
        <tr><th>Keterangan</th><td><?php echo htmlspecialchars($resV['Keterangan']); ?></td></tr>
      </table>
