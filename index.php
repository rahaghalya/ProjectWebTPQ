...
<main class="main">
      ...
      <div class="row gy-4 align-items-center">
        <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
          <div class="text-center">
            <img src="assets/img/about/WhatsApp Image 2025-11-26 at 08.42.02.jpeg" class="img-fluid rounded" alt="Ilustrasi Metode Pembelajaran" style="height: auto;">
  ...
  <section id="home-description" class="home-description section">
    <div class="container" data-aos="fade-up">
      <div class="row gy-4 align-items-center">
        <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
          <h4>Izin Mengajar Resmi</h4>
          <h4 style="font-weight: 600; color: var(--heading-color); margin-top: 1.5rem;"></h4>
          <p>
            Kami berkomitmen penuh terhadap integritas dan kualitas pendidikan, yang kini dibuktikan melalui status resmi instansi kami sebagai penyelenggara pendidikan Al-Qur'an yang terdaftar dan terverifikasi oleh Kementerian Agama. Status legalitas ini menjamin bahwa seluruh kurikulum, fasilitas, hingga kualifikasi pengajar yang kami miliki telah sesuai dengan standar pendidikan nasional yang berlaku. Kami hadir sebagai solusi terpercaya bagi Anda yang mencari tempat belajar Al-Qur'an yang profesional, resmi, dan memiliki kredibilitas yang diakui negara.
          </p>
        </div>
        <div class="col-lg-6" data-aos="fade-up" data-aos-delay="200">
          <div class="text-center my-3">
            <img src="assets/img/about/IZIN OPERASIONAL.jpg"
