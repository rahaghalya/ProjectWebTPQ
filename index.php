...
$query_siswa = "SELECT COUNT(*) AS total_siswa FROM santri WHERE keterangan = 'aktif' OR keterangan IS NULL";
$result_siswa = mysqli_query($koneksi, $query_siswa);
$data_siswa = mysqli_fetch_assoc($result_siswa);
$total_siswa = $data_siswa['total_siswa'];

$query_alumni = "SELECT COUNT(*) AS total_alumni 
                 FROM santri 
                 WHERE keterangan IN ('Keluar', 'Lulus', 'Pindah')";
