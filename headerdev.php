    ...
    <div class="branding d-flex align-items-cente">
      <div class="container position-relative d-flex align-items-center justify-content-between">
        ...
        <nav id="navmenu" class="navmenu">
          ...
          // --- PENTING ---
          // Ganti 'index.php' di bawah ini jika nama file
          // halaman dashboard utama Anda berbeda (misal: 'dashboard.php' atau 'admin.php')
          $dashboardPage = 'dashboard.php'; 

          if ($currentPage == $dashboardPage) {
              // 1. DI HALAMAN DASHBOARD
              // Sesuai permintaan Anda, hamburger dihilangkan (tidak ada output)
              
          } else {
              // 2. DI HALAMAN LAIN (Siswa, Guru, Berita, dll.
              // Tampilkan tombol KEMBALI ke dashboard
              echo '<a href="' . htmlspecialchars($dashboardPage) . '" class="mobile-back-btn bi bi-arrow-left" aria-label="Kembali"></a>';
          }
          ?>
        </nav>
      </div>
